    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"Muhammad Iqbal Mubarok");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Muhammad Iqbal Mubarok");
                mPerson.setAge(16);
                mPerson.setEmail("muhammadiqbalmubarok@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "08995969485";
